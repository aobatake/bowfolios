...
if (Meteor.isServer) {
  describe('ProfileCollection', function testSuite() {
    ...
    const defineObject = { firstName, lastName, username, bio, location,
      interests, picture, title, github, facebook, instagram };
    ...
    it('#define (duplicate interests)', function test() {
      ...
      const defineObject3 = { firstName, lastName, location, username,
        bio, interests: duplicateInterests, picture, title, github, facebook, instagram };
